...
public class RegisterPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfRegistration() {
        new RegisterPage().enterFirstName("pradip");
        new RegisterPage().enterLastName("kakadiya");
        new RegisterPage().enterEmail("pradip"+ Utility.getRandomString(4)+"@gmail.com");
        new RegisterPage().enterTelephone("086523521");
        new RegisterPage().enterPassword("pradip123");
        new RegisterPage().enterConfirmPassword("pradip123");
